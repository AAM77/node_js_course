...
console.log(chalk.red.dim.bold('Error!'));
console.log(chalk.green.dim.bold('Success!'));
console.log(chalk.green('I am a green line ' + chalk.yellow.underline.bold('with a yellow substring') + ' that becomes green again!'));
